...
class TestTyperEcho:
    def test_message_logs_info(self) -> None:
        with patch("logly.integrations._utils.logger") as mock_logger:
            typer_echo("hello")
